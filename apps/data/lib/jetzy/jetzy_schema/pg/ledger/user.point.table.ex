defmodule JetzySchema.PG.Ledger.User.Point.Table do
  @moduledoc """
  ...
  JetzySchema.NoizuTableBehaviour.entity_table(:vnext_ledger_user_point)

  @primary_key {:identifier, Ecto.UUID, autogenerate: false}
  @derive {Phoenix.Param, key: :identifier}
  schema "vnext_ledger_user_point" do
