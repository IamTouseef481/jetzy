defmodule JetzySchema.PG.Ledger.Reward.Reward.Table do
  @moduledoc """
  ...
  JetzySchema.NoizuTableBehaviour.entity_table(:vnext_ledger_reward_reward)

  @primary_key {:identifier, Ecto.UUID, autogenerate: false}
  @derive {Phoenix.Param, key: :identifier}
  schema "vnext_ledger_reward_reward" do
