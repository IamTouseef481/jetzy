...
defmodule Jetzy.Location.Country.TypeHandler do
  ...
  # from_partial
  #--------------------------------------
  def from_partial(%{__struct__: Jetzy.Location.Country.Entity} = v, _context, _options), do: v
  def from_partial({:ref, Jetzy.Location.Country.Entity, _} = v, _context, _options), do: v
