...
defmodule Jetzy.Location.City.TypeHandler do
  ...
  # from_partial
  #--------------------------------------
  def from_partial(%{__struct__: Jetzy.Location.City.Entity} = v, _context, _options), do: v
  def from_partial({:ref, Jetzy.Location.City.Entity, _} = v, _context, _options), do: v
