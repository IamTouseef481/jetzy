...
defmodule Jetzy.User.Point.Balance do
  use Noizu.DomainObject
  @vsn 1.0
  @sref "user-point-balance"
  ...
  defmodule Entity do
    ...
    Noizu.DomainObject.noizu_entity do
      ...
      public_field :balance
      public_field :at_transaction # Last User Transaction Id included in roll up
