defmodule Jetzy.Degree.TypeHandler do
  ...
  # from_partial
  #--------------------------------------
  def from_partial(%{__struct__: Jetzy.Degree.Entity} = v, _context, options), do: v
    ...
    update_in(
      ...
      fn (x) ->
        ...
        if pi && pi.identifier == nil do
          Jetzy.Degree.Repo.create(pi, context, options)
        else
          pi
        end |> Noizu.ERP.ref()
      end
