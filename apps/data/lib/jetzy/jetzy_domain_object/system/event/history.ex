...
defmodule Jetzy.System.Event.History do
  use Noizu.DomainObject
  @vsn 1.0
  @sref "system-event-history"
  ...
  defmodule Entity do
    ...
    Noizu.DomainObject.noizu_entity do
      identifier :uuid
      public_field :system_event, nil, JetzySchema.Types.System.Event.Reference
      public_field :user, nil, Noizu.DomainObject.UUID.UniversalLink.TypeHandler
      public_field :transaction, nil, Noizu.DomainObject.UUID.UniversalLink.TypeHandler
