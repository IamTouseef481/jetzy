...
defmodule Jetzy.LegacyResolution.Source.Enum do
  ...
  def atom_to_enum() do
    Jetzy.DomainObject.Schema.__legacy_source_atom_to_enum__()
  end
  def atom_to_enum(k), do: atom_to_enum()[k]

  def enum_to_atom() do
    Jetzy.DomainObject.Schema.__legacy_source_enum_to_atom__()
  end
  def enum_to_atom(k), do: enum_to_atom()[k]

  def json_to_atom() do
    Jetzy.DomainObject.Schema.__legacy_source_json_to_atom__()
  end
